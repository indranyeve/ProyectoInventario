...
namespace WebApiInventario.Controllers
{
    public class TipoInventarioController : ApiController
    {
        ...
        public IQueryable<TipoInventario> GetTipoInventario()
        {
            return db.TipoInventario.Where(x => x.Estado.Equals("1")); 
        }
        ...
        {
            return db.TipoInventario.Count(e => e.Id_TipoInventario == id) > 0;
        }
    }
}